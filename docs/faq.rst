...
This is a list of Frequently Asked Questions regarding using ``sonicord`` and its extension modules. Feel free to suggest a
...
Example code can be found in the `examples folder <https://github.com/sonicord-Development/sonicord/tree/master/examples>`_
in the repository.
...
`Check the background_task.py example. <https://github.com/sonicord-Development/sonicord/blob/master/examples/background_task.py>`_
